...
public interface ChannelPermissionsApi {
     ...
     * @return 修改结果
     */
    public abstract Boolean modifyChannelPermissionsByRole_id(Bot bot, String channel_id, String role_id, String add, String remove);
     ...
     * @return 返回修改结果
     */
    public abstract Boolean modifyChannelPermissionsByUser_id(Bot bot, String channel_id, String user_id, String add, String remove);
