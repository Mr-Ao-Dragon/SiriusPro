...
public interface ApiPermissionApi {
     ...
     * @return Api接口权限需求对象
     */
    public abstract Tuple<ApiPermissionDemand,String> createApiGrantLink(@NonNull @ENonNull String bot_id, String guild_id, String channel_id, ApiPermissionDemandIdentify api_identify, String desc);
     ...
     */
    public abstract Tuple<List<APIPermission>,String> getAPIPermissions(@NonNull @ENonNull String bot_id, String guild_id);
}
