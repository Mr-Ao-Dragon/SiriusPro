...
public class MemberApiController {
     ...
     *
     */
    @GetMapping("/get-members/{bot_id}/{guild_id}/{after}/{limit}")
    public R getMemberList(@PathVariable String bot_id, @PathVariable String guild_id, @PathVariable @Nullable String after, @PathVariable @Nullable Integer limit){
        try{
...
`    /**
     ...
     */
    @GetMapping("/get-role-member/{bot_id}/guild_id/{role_id}/{start_index}/{limit}")
    public R getMemberListByRoleId(@PathVariable String bot_id,@PathVariable String guild_id,@PathVariable String role_id,@Nullable @PathVariable String start_index, @Nullable @PathVariable Integer limit){
        try{
    ...
    public R deleteMemberByUserId(@PathVariable String bot_id,@PathVariable String guild_id,@PathVariable String user_id,@RequestParam Boolean add_black,@RequestParam Integer delete_history_msg_days){
        try{
